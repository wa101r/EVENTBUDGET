...
<template>
  <div class="min-h-screen bg-[#f5f7fb]">
    ...
    <!-- HEADER -->
    <header
      class="sticky top-0 z-40 bg-white border-b border-gray-200 shadow-[0_8px_24px_rgba(16,36,94,0.06)]
        ...
        <NuxtLink
          ...
          :class="[
            ...
            isActive('/event-manage')
              ? 'bg-[#fff3eb] text-[#ff7a3c] font-semibold'
